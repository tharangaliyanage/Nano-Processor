...
##7 segment display
set_property PACKAGE_PIN W7 [get_ports {Seven_seg_out[6]}]
	set_property IOSTANDARD LVCMOS33 [get_ports {Seven_seg_out[6]}]
set_property PACKAGE_PIN W6 [get_ports {Seven_seg_out[5]}]
	set_property IOSTANDARD LVCMOS33 [get_ports {Seven_seg_out[5]}]
set_property PACKAGE_PIN U8 [get_ports {Seven_seg_out[4]}]
...
set_property PACKAGE_PIN U5 [get_ports {Seven_seg_out[2]}]
	set_property IOSTANDARD LVCMOS33 [get_ports {Seven_seg_out[2]}]
set_property PACKAGE_PIN V5 [get_ports {Seven_seg_out[1]}]
	set_property IOSTANDARD LVCMOS33 [get_ports {Seven_seg_out[1]}]
set_property PACKAGE_PIN U7 [get_ports {Seven_seg_out[0]}]
